...
IMPORTANT_ACTIONS = {
    ...
    "create_course_ent_variant": AuditAction("ent.course_variant_create", "ent_variant", "Курсқа пәндік ҰБТ варианты құрылды"),
    "update_course_ent_variant": AuditAction("ent.course_variant_update", "ent_variant", "Курстың ҰБТ варианты өзгертілді"),
    "delete_course_ent_variant": AuditAction("ent.course_variant_delete", "ent_variant", "Курстың ҰБТ варианты жойылды"),
    "set_course_ent_subject": AuditAction("course.ent_subject", "course", "Курстың ҰБТ пәні орнатылды"),
